...
class MemoryBlossom:
    ...
    def get_all_memories(self) -> List[Memory]:
        """
        Retrieves all memories from all stores without performing a semantic search.
        Ideal for browsing, editing, or exporting all available memories.
        """
        ...
        all_memories_flat.sort(key=lambda x: x.creation_time, reverse=True)
        return all_memories_flat
